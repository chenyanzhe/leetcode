...
TEST_CASE("Multiply Strings") {
  ...
  SECTION("Overflow tests") {
    ...
    REQUIRE(s.multiply(to_string(ULLONG_MAX), to_string(ULLONG_MAX)) == "340282366920938463426481119284349108225");
    REQUIRE(s.multiply("340282366920938463426481119284349108225", "340282366920938463426481119284349108225") == "115792089237316195398462578067141184799968521174335529155754622898352762650625");
  }
}
