...
TEST_CASE("Fraction to Recurring Decimal") {
    ...
    SECTION("Special tests") {
        ...
        REQUIRE(s.fractionToDecimal(-1, -2147483648) == "0.0000000004656612873077392578125");
        string long_string = "0.00";
        long_string += "(000000465661289042462740251655654056577585848337359161441621040707904997124";
        long_string += "9140691940265491382276607238786694551954770654271433704612529667513555539822";
        long_string += "4128031075477715862831904973208550263973140209813193268378053860284588710533";
        long_string += "7854867197032523144157689601770377165713821223802198558308923834223016478952";
